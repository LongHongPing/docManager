...
<div id="container_demo" >
	...
	<div id="wrapper">
		...
		<div id="register" class="animate form">
			<form  form action="${pageContext.request.contextPath}/user/register" method="post"  autocomplete="on">
				<h1>注册</h1> 
				<p> 
					<label for="usernamesignup" class="uname" data-icon="u">用户名</label>
					<input id="usernamesignup" name="usernamesignup" required="required" type="text" placeholder="用户名必须6-20位" />
				</p>
				<p> 
				...
				<p> 
					...
					<input id="passwordsignup" name="passwordsignup" required="required" type="password" placeholder="用户名必须6-20位"/>
				</p>
				<p> 
