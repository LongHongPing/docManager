...
package com.hp.securedocdisk.word.dictionary;

import com.hp.securedocdisk.word.dictionary.impl.DictionaryTrie;
import com.hp.securedocdisk.word.recognition.PersonName;
import com.hp.securedocdisk.word.util.AutoDetector;
import com.hp.securedocdisk.word.util.ResourceLoader;
import com.hp.securedocdisk.word.util.WordConfTools;
    ...
    private static final class DictionaryHolder{
        ...
        private static Dictionary constructDictionary(){  
            try{
                ...
                String dicClass = WordConfTools.get("dic.class", "com.hp.securedocdisk.word.dictionary.impl.TrieV4");
        ...
        public static void reload(){
            ...
            }, WordConfTools.get("dic.path", "classpath:word/dic.txt")
                    + "," + WordConfTools.get("punctuation.path", "classpath:word/punctuation.txt")
                    + "," + WordConfTools.get("part.of.speech.dic.path", "classpath:word/part_of_speech_dic.txt")
                    + "," + WordConfTools.get("word.synonym.path", "classpath:word/word_synonym.txt")
                    + "," + WordConfTools.get("word.antonym.path", "classpath:word/word_antonym.txt"));
        }
    }
